...
import comicManagement.ComicGradeoFichero;
...
public class FuncionesExcel {
	...
	// Para portadas
	public static final String DEFAULT_PORTADA_IMAGE_PATH = DOCUMENTS_PATH + File.separator + "gradeo_comics"
			+ File.separator + Utilidades.nombreDB() + File.separator + "portadas";

	// Para la base de la ruta de imágenes predeterminada
	private static final String DEFAULT_IMAGE_PATH_BASE = DOCUMENTS_PATH + File.separator + "gradeo_comics"
	...
	public Task<Boolean> trabajarFichero(List<ComicGradeo> listaComics, String tipoBusqueda, File[] directorioImagenes,
			...
			protected Boolean call() throws Exception {
				try {
					...
					if (directorioFichero[0] != null) {
						...
						List<ComicGradeo> listaComicsCopia = new ArrayList<>(listaComics);
	...
	private int escribirDatosComics(List<ComicGradeo> listaComics, Sheet hoja,
